...
\todo[inline]{new ACM classifications are weird, this was best I had for ``category''.
other options:
Software and its engineering; Virtual worlds software; Interactive Games
or something about management/operations...}
...
\begin{table}[tbp]
\centering
\caption{Comparison of acquisition-objective function F1 scores.
Sample sizes indicate values averaged over a range of $\pm$5 samples (for smoothing).
Higher values indicate better performance.}
% % scriptsize version
\scriptsize
...
AL can reduce the expense of playtesting to achieve a design goal by intelligently picking designs to test.
...
Using AL is especially powerful when coupled to online playtesting, enabling a machine to simultaneously optimize many parameters without burdening the designer.
...
\todo[inline]{not sure where best to mention limitations}
...
\todo[inline]{this may be out of place or useless...}
We believe machine--driven playtesting may provide insights into how to best perform playtests.
