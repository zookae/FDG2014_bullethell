...
We argue that research to date has ignored the problem of reducing ``sample complexity''---the number of data points (human playtests) needed to train a model.
...
\todo[inline]{not sure where to slot this in}
...
We extend these efforts with a wider variety of AL approaches while addressing the cost of playtesting.
...
Kernel methods (particularly KSVMs) are a popular machine learning technique previously used in player modeling \cite{yu2011:minboredom} and optimized neural networks have been widely used in preference learning \cite{yannakakis2011:edpcg}.\footnote{For computational reasons we employ a simple gradient-based optimization method, rather than the more common neuro-evolutionary approaches. 
...
%\begin{tabular}{|c|c|c|}
%\hline
%\textbf{\begin{tabular}[c]{@{}c@{}}acquisition\\ function\end{tabular}} & \textbf{MSE 80 samples} & \textbf{MSE 280 samples} \\ \hline
%random                                                                  & 1.91                    & 1.36                     \\ \hline
...
As more samples are gathered GP-UCB is better able to reduce exploration while EI eventually begins to make poor playtest choices.
...
Our classification experiments show AL can produce useful results with few samples, but is generally more challenging in subjective domains.
In simulation data AL methods always yielded improvements over random sampling.
...
It is also possible players differ enough in preferred controls to prevent good model learning across all players.

% sim: 
%	random: NE > GP > KSVM
%	AL: NE QBB vote > GP entropy > KSVM QBB vote
...
random                                                                          & 0.738          & 0.722          & 0.736          & 0.807          & 0.798          & 0.893          \\ \hline
entropy                                                                         & 0.759          & 0.705          & -              & \textbf{0.843} & 0.821          & -              \\ \hline
QBB vote                                                                        & \textbf{0.788} & \textbf{0.744} & \textbf{0.749} & 0.815          & \textbf{0.829} & \textbf{0.963} \\ \hline
QBB prob                                                                        & 0.680          & 0.676          & -              & 0.839          & 0.804          & -              \\ \hline
\end{tabular}
%
% % non-scriptsize
%\begin{tabular}{|c|c|c|c|c|c|c|}
...
%\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}acquisition\\ function\end{tabular}} & \multicolumn{3}{|c|}{80 samples} & \multicolumn{3}{|c|}{280 samples} \\ \cline{2-7} 
%\multicolumn{1}{|l|}{}                                                          & GP        & KSVM      & NE       & GP        & KSVM      & NE        \\ \hline
%random                                                                          & 0.74      & 0.72      & 0.74     & 0.81      & 0.80      & 0.90      \\ \hline
%entropy                                                                         & 0.76      & 0.71      & 0.76     & 0.84      & 0.82      & 0.90      \\ \hline
%QBB vote                                                                        & 0.79      & 0.74      & 0.75     & 0.82      & 0.83      & 0.96      \\ \hline
%QBB prob                                                                        & 0.68      & 0.68      & 0.68     & 0.84      & 0.80      & 0.76      \\ \hline
%\end{tabular}
\label{tab:cls_sim}
\end{table}
...
In simulation QBB vote and entropy sampling showed strong performance gains across all three objective functions (Figure \ref{fig:cls_all}, Table \ref{tab:cls_sim}).
...
\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}acquisition\\ function\end{tabular}} & \multicolumn{3}{|c|}{80 samples} & \multicolumn{3}{|c|}{280 samples}       \\ \cline{2-7} 
\multicolumn{1}{|l|}{}                                                          & GP        & KSVM      & NE       & GP             & KSVM           & NE    \\ \hline
random                                                                          & 0.713     & 0.653     & 0.679    & 0.758          & 0.749          & 0.744 \\ \hline
entropy                                                                         & 0.713     & 0.689     & -        & 0.763          & 0.753          & -     \\ \hline
QBB vote                                                                        & 0.714     & 0.699     & 0.698    & \textbf{0.778} & \textbf{0.786} & 0.777 \\ \hline
QBB prob                                                                        & 0.711     & 0.704     & -        & \textbf{0.779} & \textbf{0.792} & -     \\ \hline
\end{tabular}
%
...
The comparatively poor performance of NE in this setting suggests the model was overfitting simulation data and unable to accommodate the noise in human results.
...
Reducing playtest costs, however, requires acquisition functions (e.g. entropy sampling or QBB) that mitigate the high variance inherent in preference response data.
