...
In both simulation studies AL almost always reduced the number of playtests needed. % TODO: check if PI was appropriately implemented...
...
% % argue GP standard regression, prob model helps AL use
% % GP non-standard for classification -> others
...
%\begin{table}[tb]
%\centering
%\caption{Comparison of acquisition-objective function combination accuracy with few (80) and many (280) playtest samples of simulated data (units are $10^{-2}$).}
%\begin{tabularx}{0.48\textwidth}{|X|c|c|c|c|c|c|}
...
%\hline UCB & 1.48 & - & - 
% & 1.38 & - & - \\ 
%\hline min MSE & 3.01 & 2.65 & 2.70 
% & 2.54 & 2.66 & 2.78 \\ 
%\hline min MAE & 2.85 & 2.65 & 2.64 
% & 2.53 & 2.69 & 2.66 \\ 
%\hline 
%\end{tabularx}
%\label{tab:reg_sim}
...
%\toprule
%\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}acquisition\\ function\end{tabular}} & \multicolumn{3}{l}{MSE 80 samples} & \multicolumn{3}{l}{MSE 280 samples} \\ \cmidrule(l){2-7} 
%                                                                                & GP         & KSVM      & NE        & GP         & KSVM       & NE        \\ \midrule
%random                                                                          & 1.91       & 1.58      & 1.62      & 1.36       & 1.29       & 1.31      \\ \midrule
%variance                                                                        & 1.50       & -         & -         & 1.39       & -          & -         \\ \midrule
%PI                                                                              & 8.32       & -         & -         & 6.38       & -          & -         \\ \midrule
%EI                                                                              & 1.60       & -         & -         & 1.30       & -          & -         \\ \midrule
%UCB                                                                             & 1.48       & -         & -         & 1.38       & -          & -         \\ \midrule
%min MSE                                                                         & 3.01       & 2.65      & 2.70      & 2.54       & 2.66       & 2.78      \\ \midrule
%min MAE                                                                         & 2.85       & 2.65      & 2.64      & 2.53       & 2.69       & 2.66      \\ \bottomrule
%\end{tabular}
%\end{table}
...
\hline
\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}acquisition\\ function\end{tabular}} & \multicolumn{3}{|l|}{MSE 80 samples} & \multicolumn{3}{|l|}{MSE 280 samples} \\ \cline{2-7} 
...
EI                                                                              & 1.60       & -          & -          & 1.30        & -          & -          \\ \hline
UCB                                                                             & 1.48       & -          & -          & 1.38        & -          & -          \\ \hline
%min MSE                                                                         & 3.01       & 2.65       & 2.70       & 2.54        & 2.66       & 2.78       \\ \hline
%min MAE                                                                         & 2.85       & 2.65       & 2.64       & 2.53        & 2.69       & 2.66       \\ \hline
\end{tabular}
\label{tab:reg_sim}
\end{table}
...
EI                                                                              & 112        & -           & -         & 127        & -           & -          \\ \hline
UCB                                                                             & 107        & -           & -         & 117        & -           & -          \\ \hline
%min MSE                                                                         &            & 328         & 303       &            & 355         & 294        \\ \hline
%min MAE                                                                         &            & 364         &           &            & 396         &            \\ \hline
\end{tabular}
\label{tab:reg_expr}
\end{table}
